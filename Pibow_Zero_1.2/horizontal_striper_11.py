#!/usr/bin/python3
"""
Horizontal Striper 11 - Pibow Zero 1.2
...
Functions:
- horizontal_striper_11: Gets x and y coordinates and sends them to the
      striping function
