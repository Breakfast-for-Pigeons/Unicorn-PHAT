#!/usr/bin/python3
"""
Double Ripple 1 - Pibow Zero 1.2
...
Functions:
- double_ripple_1: Gets 9 rainbows and sends them to the double ripple
      function
...
def double_ripple_1():
    """
    Gets 9 rainbows and sends them to the double ripple function.
    """

    rainbow00 = get_horizontal_rainbow_00()

    rainbow01, rainbow02, rainbow03, rainbow04, rainbow05, rainbow06, \
        rainbow07, rainbow08 = get_double_ripple_rainbows_1()

    dr_rainbows_1 = [rainbow01, rainbow02, rainbow03, rainbow04,
                     rainbow05, rainbow06, rainbow07, rainbow08]

    double_ripple(rainbow00, dr_rainbows_1)
