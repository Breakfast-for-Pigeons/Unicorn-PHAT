#!/usr/bin/env python
################################################################
#          Pibow Zero W Demo for the Unicorn pHAT            #
################################################################
# Description:                                                 #
...
color_list = [
    (0,0, 255), (128,0,128), (255,0,0), (255, 255, 255) 
]
    
y_coordinates = [0, 1, 2, 3]
x_coordinates = [0, 1, 2, 3, 4, 5, 6, 7]

x0_color_tuple  = (0,0, 255)
x1_color_tuple  = (128,0,128) 
x2_color_tuple  = (255,0,0)
x3_color_tuple  = (255, 255, 255)
x4_color_tuple  = (0,0, 255)
x5_color_tuple  = (128,0,128) 
x6_color_tuple  = (255,0,0)
x7_color_tuple  = (255, 255, 255)

y0_color_tuple  = (0,0, 255)
y1_color_tuple  = (128,0,128) 
y2_color_tuple  = (255,0,0)
