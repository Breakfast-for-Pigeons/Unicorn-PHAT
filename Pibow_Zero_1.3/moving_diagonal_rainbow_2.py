#!/usr/bin/python3
"""
Moving Diagonal Rainbow 2 - Pibow Zero 1.3
...
Functions:
- moving_diagonal_rainbow_2: Retrieves the rainbows and sends them to
      the move function.
...
def moving_diagonal_rainbow_2():
    """
    Gets 4 rainbows, assigns them in reverse order, and then
    sends them to the move_diagonally function
    """
