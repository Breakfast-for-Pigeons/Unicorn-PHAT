#!/usr/bin/python3
"""
Diagonal Ripple 1 - Pibow Zero 1.3
...
Functions:
- diagonal_ripple_1: Gets 12 rainbows and sends them to the ripple
      diagonally function
...
def diagonal_ripple_1():
    ...
    rainbow01, rainbow02, rainbow03, rainbow04, rainbow05, rainbow06, \
        ...
        rainbow11 = get_diagonal_ripple_rainbows_1()

    diagonal_rainbows_1 = [rainbow01, rainbow02, rainbow03, rainbow04,
                           rainbow05, rainbow06, rainbow07, rainbow08,
                           rainbow09, rainbow10, rainbow11]

    ripple_diagonally(rainbow00, diagonal_rainbows_1)
